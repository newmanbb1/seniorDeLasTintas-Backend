...
export class EvolutionApiService {
  ...
  async sendMessage(to: string, message: string): Promise<void> {
    if (!this.evolutionAvailable) {
      this.logger.warn(`Evolution API no disponible, mensaje no enviado a ${to}`);
      return;
    }
  ...
  async sendListMessage(to: string, title: string, description: string, sections: any[]): Promise<void> {
    if (!this.evolutionAvailable) {
      this.logger.warn(`Evolution API no disponible, mensaje de lista no enviado a ${to}`);
      return;
    }
  ...
  async sendButtonsMessage(to: string, title: string, buttons: any[]): Promise<void> {
    if (!this.evolutionAvailable) {
      this.logger.warn(`Evolution API no disponible, mensaje de botones no enviado a ${to}`);
      return;
    }
